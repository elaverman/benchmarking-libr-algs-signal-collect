...
class TabuSearchVertex(
  ...
  with TabuListDecision[Int] // TODO: argmaxBI seems to have an inpact on scoreSignal since the algorithm changes its state more often therefore converging mory slowly
